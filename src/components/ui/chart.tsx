    ...
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        className={cn(
          ...
          // Line marks keep their own series stroke; the border outline is for filled shapes (bars, areas, sectors)
          "[&_.recharts-layer_path]:[fill-opacity:1] [&_.recharts-layer_path]:stroke-2 [&_.recharts-layer_path:not(.recharts-line-curve)]:[stroke:var(--color-border)]",
          className,
        )}
        {...props}
      >
