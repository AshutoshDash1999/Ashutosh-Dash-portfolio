                ...
                {cards.map((card) => {
                    ...
                    return (
                        <motion.button
                            ...
                            type="button"
                            disabled={
                                gameState !== "playing" || card.matched
                            }
                            className="relative w-full border-0 bg-transparent p-0 text-left shadow-none outline-none ring-0 perspective-[1000px] transition-all duration-300 enabled:cursor-pointer disabled:cursor-default enabled:hover:scale-105 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
